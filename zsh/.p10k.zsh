# Generated by Powerlevel10k configuration wizard on 2021-07-27 at 14:35 CEST.
...
() {
  ...
  #typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubie|k|kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k10s|helmfile|flux|fluxctl|stern'
